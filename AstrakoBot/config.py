...
class Config(object):
    ...
    API_ID = 2170492  # integer value, don't use ""
    ...
    OWNER_ID = 1159381624  # If you don't know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Ruined_soul"
    SUPPORT_CHAT = "grouptdsupport"  # Your own group for support, do not add the @
    JOIN_LOGGER = -1002472321139  # Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = -1002472321139  # Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and more.
    ALLOW_CHATS = True
    ...
    DB_NAME = "xebal"  # needed for cron_jobs module, use same database name from SQLALCHEMY_DATABASE_URI
    LOAD = []
    ...
    # Set the port dynamically from the environment variable
    ...
    WALL_API = "awoo"  # For wallpapers, get one from https://pixabay.com/api/docs
